...
#include "../evolution/webots/differential_wheels.h"
#include "../evolution/webots/distance_sensor.h"
#include "../evolution/webots/led.h"
#include "../evolution/webots/supervisor.h"
#include "../evolution/webots/receiver.h"
#include "../evolution/webots/emitter.h"
#include "../evolution/webots/gps.h"
#include "../evolution/webots/camera.h"
...
#define NB_TOT_OUT (NB_OUTPUTS+NB_HIDDEN_NEURONS) //6 total neurons in the "output" layer at time t. Only 2 of these acutate wheels.
...
#define NB_IN_S (NB_INPUTS+NB_FS) //5 sensor inputs in total
#define NB_IN  (NB_INPUTS+NB_FS+NB_TOT_OUT) //11 inputs total including outputs from previous time step
...
//#else
//  #define NB_WEIGHTS ((NB_INPUTS+NB_FS+NB_HIDDEN_NEURONS+NB_OUTPUTS)*(NB_OUTPUTS+NB_HIDDEN_NEURONS))+(NB_TC)+(NB_BIAS)
//#endif
