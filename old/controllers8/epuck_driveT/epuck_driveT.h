...
***************************************************************************/
#ifndef EPUCK_DRIVET_H
#define EPUCK_DRIVET_H
...
// Global defines C:\Program Files (x86)\Webots\transfer\e-puck\libepuck\include
#define TRUE 1
#define FALSE 0
#define LEFT 0
#define RIGHT 1
...
const double PS_OFFSET_SIMULATION[NB_DIST_SENS] = {300,300,300,300,300,300,300,300};
